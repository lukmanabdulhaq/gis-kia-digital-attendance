...
```bash
git remote add encore encore://gis-kia-digital-attendance-z3ri
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/gis-kia-digital-attendance-z3ri/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/gis-kia-digital-attendance-z3ri/settings/integrations/github)
